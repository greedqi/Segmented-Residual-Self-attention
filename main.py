...
parser.add_argument('--model', type=str, required=True, default='srformer',help='model of experiment')
...
parser.add_argument('--R_n', type=int, default=16, help='num of encoder layers')#16
...
for ii in range(args.itr):
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_rn{}_dl{}_df{}_fc{}_eb{}_mx{}_{}_{}'.format(args.model, args.data, args.features, 
                args.seq_len, args.label_len, args.pred_len,
                args.d_model, args.n_heads, args.R_n, args.d_layers, args.d_ff, args.factor, 
